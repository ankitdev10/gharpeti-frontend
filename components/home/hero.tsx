...
export const Hero = () => (
  <div className='px-12 light:bg-gray-100 py-20 min-h-[calc(100vh-64.8px)] grid grid-cols-[600px_1fr] items-center gap-16'>
    ...
    <div className='relative h-full hidden md:block'>
      <div className="absolute z-10 inset-0 before:content-[''] before:absolute before:inset-0 before:bg-[url('/hero-map2.jpg')] before:bg-cover before:blur-[1px] before:-z-10" />
